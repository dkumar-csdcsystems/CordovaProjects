...
!function (t) {
    ...
    function p(t) {
        var e, n = t.innerWidth() - t[0].clientWidth, i = t.innerHeight() - t[0].clientHeight;
        return n = v(n),
        i = v(i),
        e = {
            left: 0,
    ...
    function P(t, e, n) {
        var i;
        return J(n) ? (e - t) / n : (i = n.asMonths(),
        Math.abs(i) >= 1 && pt(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
    }
    function _(t, e) {
        var n, i;
        return J(t) || J(e) ? t / e : (n = t.asMonths(),
        i = e.asMonths(),
        Math.abs(n) >= 1 && pt(n) && Math.abs(i) >= 1 && pt(i) ? n / i : t.asDays() / e.asDays())
    }
    function Y(t, n) {
        var i;
        return J(t) ? e.duration(t * n) : (i = t.asMonths(),
        Math.abs(i) >= 1 && pt(i) ? e.duration({
            months: i * n
        }) : e.duration({
            days: t.asDays() * n
        }))
    ...
    function U(t, e) {
        ...
        e.end && (t.end = X(t.end, e.end)),
        t
    }
    function j(t, e) {
        return t = t.clone(),
        e.start && (t = K(t, e.start)),
    ...
    function yt(n, i, r) {
        ...
        return e.isMoment(u) || tt(u) || void 0 === u ? l = e.apply(null, n) : (s = !1,
        o = !1,
        c ? te.test(u) ? (u += "-01",
        n = [u],
        s = !0,
        o = !0) : (a = ee.exec(u)) && (s = !a[5],
        o = !0) : t.isArray(u) && (o = !0),
        l = i || s ? e.utc.apply(e, n) : e.apply(null, n),
        s ? (l._ambigTime = !0,
        l._ambigZone = !0) : r && (o ? l._ambigZone = !0 : c && l.utcOffset(u))),
        l._fullCalendar = !0,
        l
    }
    function St() { }
    function wt(t, e) {
        var n;
        return st(e, "constructor") && (n = e.constructor),
        "function" != typeof n && (n = e.constructor = function () {
            t.apply(this, arguments)
        }
        ),
        n.prototype = it(t.prototype),
        rt(e, n.prototype),
        rt(t, n),
        n
    }
    ...
    function Dt(t) {
        function e(t) {
            return new Et(function (e) {
                var i = function () {
                    Et.resolve(t()).then(e).then(function () {
                        n.shift(),
                        n.length && n[0]()
                    })
                };
        ...
        var n = [];
        this.add = "number" == typeof t ? mt(e, t) : e,
        this.addQuickly = e
    }
    function Tt(t, e) {
    ...
    function It(t) {
        return lt((t.source || {}).rendering, t.rendering)
    }
    function kt(t) {
        var e, n, i = {};
    ...
    function Mt(n) {
        var i, r, s, o, a = qt.dataAttrPrefix;
        return a && (a += "-"),
        ...
        function o(i) {
            ...
            return s && t.each(s.split(" "), function (n) {
                ...
                t.each(this.split(","), function (n, i) {
                    var r, a, l, u, c, d, h, f, g, m;
                    "title" == i ? (s = s.add(t("<h2>&nbsp;</h2>")),
                    o = !1) : ((r = (e.options.customButtons || {})[i]) ? (l = function (t) {
                        r.click && r.click.call(m[0], t)
                    }
                    ,
                    u = "",
                    c = r.text) : (a = e.getViewSpec(i)) ? (l = function () {
                        e.changeView(i)
                    }
                    ,
                    v.push(i),
                    u = a.buttonTextOverride,
                    c = a.buttonTextDefault) : e[i] && (l = function () {
                        e[i]()
                    }
                    ,
                    u = (e.overrides.buttonText || {})[i],
                    c = e.options.buttonText[i]),
                    l && (d = r ? r.themeIcon : e.options.themeButtonIcons[i],
                    h = r ? r.icon : e.options.buttonIcons[i],
                    f = u ? ut(u) : d && e.options.theme ? "<span class='ui-icon ui-icon-" + d + "'></span>" : h && !e.options.theme ? "<span class='fc-icon fc-icon-" + h + "'></span>" : ut(c),
                    g = ["fc-" + i + "-button", p + "-button", p + "-state-default"],
                    m = t('<button type="button" class="' + g.join(" ") + '">' + f + "</button>").click(function (t) {
                        m.hasClass(p + "-state-disabled") || (l(t),
                ...
                o && s.first().addClass(p + "-corner-left").end().last().addClass(p + "-corner-right").end(),
                s.length > 1 ? (i = t("<div/>"),
    ...
    function _t(n, i) {
        ...
        function o() {
            ...
            b(),
            E(),
            u(F.options.defaultView),
            F.options.handleWindowResize && (Y = mt(v, F.options.windowResizeDelay),
            t(window).resize(Y))
        }
        function a() {
            P && P.removeElement(),
            z.proxyCall("removeElement"),
            O.remove(),
            n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"),
            n.off(".fc"),
            Y && t(window).unbind("resize", Y),
            ge.unneeded()
        }
        function l() {
            return n.is(":visible")
        ...
        function u(e, n) {
            ...
            i && (H(),
            c()),
            !P && e && (P = F.view = U[e] || (U[e] = F.instantiateView(e)),
            P.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo(O)),
            z.proxyCall("activateButton", e)),
            P && l() && (n && P.captureInitialScroll(n),
            P.setDate(F.currentDate),
            F.currentDate = P.currentDate,
            n && P.releaseScroll()),
            i && R(),
            j--
        }
        function c() {
            z.proxyCall("deactivateButton", P.type),
            P.removeElement(),
            P = F.view = null
        }
        function d() {
        ...
        function m() {
            l() && F.reportEventChange()
        }
        function y() {
            return [new Pt(F, S()), new Pt(F, w())]
        }
        function S() {
            return {
        ...
        function b() {
            A.setToolbarOptions(S()),
            A.render(),
            A.el && n.prepend(A.el)
        }
        function E() {
            G.setToolbarOptions(w()),
            G.render(),
            G.el && n.append(G.el)
        }
        function D(t, e) {
        ...
        function C(t, e) {
            var n;
            e = e || "day",
            n = F.getViewSpec(e) || F.getUnitViewSpec(e),
            F.currentDate = t.clone(),
            u(n ? n.type : null)
        }
        function H() {
            Z++ || O.css({
        ...
        function L(t) {
            ...
            if (1 === n) {
                ...
                if ("defaultDate" === e)
                    return;
                if ("businessHours" === e)
                    return void (P && (P.unrenderBusinessHours(),
                    P.renderBusinessHours()));
                if ("timezone" === e)
                    return F.rezoneArrayEventSources(),
                    void F.refetchEvents()
            }
            b(),
            E(),
            U = {},
        ...
        function M(t) {
            var e;
            for (e in t)
                F.dynamicOverrides[e] = t[e];
            F.viewSpecCache = {},
            F.populateOptionsHash();
            for (e in t)
                F.triggerOptionHandlers(e)
        }
        function B(t, e) {
        ...
        F.getView = I,
        F.option = k,
        F.recordOptionOverrides = M,
        F.publiclyTrigger = B,
        F.dynamicOverrides = {},
        F.viewSpecCache = {},
        F.optionHandlers = {},
        F.overrides = t.extend({}, i),
        F.populateOptionsHash();
        var N;
        F.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function (t, e, n, i, s, o, a) {
            if ("iso" === a && (a = "ISO"),
            N = it(Wt(t)),
            e && (N._months = e),
            n && (N._monthsShort = n),
            i && (N._weekdays = i),
            s && (N._weekdaysShort = s),
            null == o && "ISO" === a && (o = 1),
            null != o) {
                var l = it(N._week);
                l.dow = o,
            ...
            "ISO" !== a && "local" !== a && "function" != typeof a || (N._fullCalendar_weekCalc = a),
            F.currentDate && r(F.currentDate)
        }),
        F.defaultAllDayEventDuration = e.duration(F.options.defaultAllDayEventDuration),
        F.defaultTimedEventDuration = e.duration(F.options.defaultTimedEventDuration),
        F.moment = function () {
            var t;
            return "local" === F.options.timezone ? (t = qt.moment.apply(null, arguments),
            t.hasTime() && t.local()) : t = "UTC" === F.options.timezone ? qt.moment.utc.apply(null, arguments) : qt.moment.parseZone.apply(null, arguments),
            r(t),
            t
        }
        ,
        ...
        F.getDefaultEventEnd = function (t, e) {
            var n = e.clone();
            return t ? n.stripTime().add(F.defaultAllDayEventDuration) : n.add(F.defaultTimedEventDuration),
            F.getIsAmbigTimezone() && n.stripZone(),
            n
        }
        ,
        ...
        F.updateToolbarButtons = function () {
            var t = F.getNow()
              , e = P.buildRangeInfo(t)
              , n = P.buildPrevRangeInfo(F.currentDate)
              , i = P.buildNextRangeInfo(F.currentDate);
            z.proxyCall(e.isValid && !q(t, P.currentRange) ? "enableButton" : "disableButton", "today"),
            z.proxyCall(n.isValid ? "enableButton" : "disableButton", "prev"),
            z.proxyCall(i.isValid ? "enableButton" : "disableButton", "next")
        }
        ,
        F.freezeContentHeight = H,
        F.thawContentHeight = R;
        var Z = 0;
        F.initialize()
    }
    function Yt(e) {
    ...
    function Ut() {
        function n(t, e) {
            return !U.options.lazyFetching || s(t, e) ? o(t, e) : Et.resolve(Z)
        }
        function i() {
            Z = r(K),
            U.trigger("eventsReset", Z)
        }
        function r(t) {
            var e, n, i = [];
            for (e = 0; e < t.length; e++)
                n = t[e],
                n.start.clone().stripZone() < q && U.getEventEnd(n).stripZone() > j && i.push(n);
            return i
        }
        function s(t, e) {
            return !j || t < j || e > q
        ...
        function h() {
            X--,
            X || (i(K),
            U.trigger("eventsReceived", Z))
        }
        function f(e, n) {
            var i, r, s = qt.sourceFetchers;
            for (i = 0; i < s.length; i++) {
                if (r = s[i].call(U, e, j.clone(), q.clone(), U.options.timezone, n),
                r === !0)
                    return;
                if ("object" == typeof r)
                    return void f(r, n)
            ...
            var o = e.events;
            if (o)
                t.isFunction(o) ? (U.pushLoading(),
                o.call(U, j.clone(), q.clone(), U.options.timezone, function (t) {
                    n(t),
                    U.popLoading()
                })) : t.isArray(o) ? n(o) : n();
            else {
                var a = e.url;
                if (a) {
                    var l, u = e.success, c = e.error, d = e.complete;
                    l = t.isFunction(e.data) ? e.data() : e.data;
                    var h = t.extend({}, l || {})
                      , g = lt(e.startParam, U.options.startParam)
                      , p = lt(e.endParam, U.options.endParam)
                      , v = lt(e.timezoneParam, U.options.timezoneParam);
                    g && (h[g] = j.format()),
                    p && (h[p] = q.format()),
                    U.options.timezone && "local" != U.options.timezone && (h[v] = U.options.timezone),
                    U.pushLoading(),
                    t.ajax(t.extend({}, Re, e, {
                        data: h,
                        success: function (e) {
                            e = e || [];
        ...
        function N(n, i) {
            var r, s, o, a = {};
            if (U.options.eventDataTransform && (n = U.options.eventDataTransform(n)),
            i && i.eventDataTransform && (n = i.eventDataTransform(n)),
            t.extend(a, n),
            i && (a.source = i),
            a._id = n._id || (void 0 === n.id ? "_fc" + xe++ : n.id + ""),
            n.className ? "string" == typeof n.className ? a.className = n.className.split(/\s+/) : a.className = n.className : a.className = [],
            r = n.start || n.date,
            s = n.end,
            et(r) && (r = e.duration(r)),
            et(s) && (s = e.duration(s)),
            n.dow || e.isDuration(r) || e.isDuration(s))
                a.start = r ? e.duration(r) : null,
                a.end = s ? e.duration(s) : null,
                a._recurring = !0;
            else {
                if (r && (r = U.moment(r),
                !r.isValid()))
                ...
                s.isValid() || (s = null)),
                o = n.allDay,
                void 0 === o && (o = lt(i ? i.allDayDefault : void 0, U.options.allDayDefault)),
                O(r, s, o, a)
            }
            return U.normalizeEvent(a),
            a
        }
        function O(t, e, n, i) {
            i.start = t,
        ...
        function P(t) {
            ...
            t.end && t.end.stripTime()) : (t.start.hasTime() || (t.start = U.applyTimezone(t.start.time(0))),
        ...
        function W(e, n, i, r, s, o) {
            ...
            t.each(e, function (e, u) {
                ...
                d.end && d.end.add(r)),
                s && d.end.add(s),
                a && !d.allDay && (r || s) && (d.start.stripZone(),
    ...
    t.fn.fullCalendar = function (e) {
        ...
        return this.each(function (r, s) {
            ...
            r || (i = o),
            "destroy" === e && a.removeData("fullCalendar")) : l || (l = new Ee(a, e),
    ...
    ,
    ne.local = function (t) {
        return ie.local.call(this, this._ambigZone || t),
        this._ambigTime = !1,
        this._ambigZone = !1,
        this
    }
    ...
    ,
    ne.format = function () {
        return this._fullCalendar && arguments[0] ? se(this, arguments[0]) : this._ambigTime ? ae(this, "YYYY-MM-DD") : this._ambigZone ? ae(this, "YYYY-MM-DD[T]HH:mm:ss") : ie.format.apply(this, arguments)
    }
    ,
    ne.toISOString = function () {
        return this._ambigTime ? ae(this, "YYYY-MM-DD") : this._ambigZone ? ae(this, "YYYY-MM-DD[T]HH:mm:ss") : ie.toISOString.apply(this, arguments)
    }
    ,
    function () {
        function t(t, e) {
        ...
        function n(t, e, n, s, o) {
            var a;
            return t = qt.moment.parseZone(t),
        ...
        function i(t, e, n, i, r) {
            var s, o, a, l = t.sameUnits, u = e.clone().stripZone(), c = n.clone().stripZone(), f = d(t.fakeFormatString, e), g = d(t.fakeFormatString, n), p = "", v = "", m = "", y = "", S = "";
            for (s = 0; s < l.length && (!l[s] || u.isSame(c, l[s])) ; s++)
                p += f[s];
            for (o = l.length - 1; o > s && (!l[o] || u.isSame(c, l[o])) && (o - 1 !== s || "." !== f[o]) ; o--)
                v = f[o] + v;
            for (a = s; a <= o; a++)
                m += f[a],
                y += g[a];
            return (m || y) && (S = r ? y + i + m : m + i + y),
            h(p + S + v)
        }
        function r(t) {
            return w[t] || (w[t] = s(t))
        ...
        qt.formatDate = t,
        qt.formatRange = n,
        qt.oldMomentFormat = e,
        qt.queryMostGranularFormatUnit = f;
        var g = "\v"
          , p = ""
          , v = ""
    ...
    var se = qt.formatDate
      , oe = qt.formatRange
      , ae = qt.oldMomentFormat;
    qt.Class = St,
    St.extend = function () {
    ...
    Et.resolve = function (e) {
        ...
        if (Et.immediate) {
            ...
            i._value = e,
            i.then = function (t, n) {
                return "function" == typeof t ? Et.resolve(t(e)) : r.call(i, t, n)
            }
        }
        return i
    }
    ...
    Et.all = function (e) {
        ...
        if (Et.immediate)
            ...
            i = 0; i < e.length; i++)
                if (r = e[i],
                r && "function" == typeof r.state && "resolved" === r.state() && "_value" in r)
                    n.push(r._value);
                else {
        ...
        return s ? Et.resolve(n) : t.when.apply(t.when, e).then(function () {
            return t.when(t.makeArray(arguments))
        })
    }
    ,
    qt.TaskQueue = Dt;
    var le = qt.EmitterMixin = {
        on: function (e, n) {
      ...
      , ce = St.extend(ue, {
          ...
          position: function () {
              var e, n, i, r, s, o = this.options, a = this.el.offsetParent().offset(), l = this.el.outerWidth(), u = this.el.outerHeight(), c = t(window), h = d(this.el);
              r = o.top || 0,
              ...
              s = Math.min(s, n + h.outerWidth() - l - this.margin),
      ...
      , de = qt.CoordCache = St.extend({
          ...
          queryBoundingRect: function () {
              var t;
              return this.els.length > 0 && (t = d(this.els.eq(0)),
      ...
      , he = qt.DragListener = St.extend(ue, {
          options: null,
          subjectEl: null,
          originX: null,
          originY: null,
          ...
          startInteraction: function (e, n) {
              ...
              this.delay = lt(n.delay, this.options.delay, 0),
              this.minDistance = lt(n.distance, this.options.distance, 0),
    ...
    he.mixin({
        ...
        initAutoScroll: function () {
            ...
            this.isAutoScroll && this.listenTo(t, "scroll", mt(this.handleDebouncedScroll, 100))
        },
        ...
        setScrollVel: function (t, e) {
            ...
            !this.scrollTopVel && !this.scrollLeftVel || this.scrollIntervalId || (this.scrollIntervalId = setInterval(vt(this, "scrollIntervalFunc"), this.scrollIntervalMs))
        },
    ...
    var fe = he.extend({
        ...
        handleDragStart: function (t) {
            var e;
            he.prototype.handleDragStart.apply(this, arguments),
            e = this.queryHit(b(t), E(t)),
            e && this.handleHitOver(e)
        },
        handleDrag: function (t, e, n) {
            var i;
            he.prototype.handleDrag.apply(this, arguments),
            i = this.queryHit(b(n), E(n)),
            Tt(i, this.hit) || (this.hit && this.handleHitOut(),
            i && this.handleHitOver(i))
        },
        handleDragEnd: function () {
            this.handleHitDone(),
            he.prototype.handleDragEnd.apply(this, arguments)
        },
        ...
        handleInteractionEnd: function () {
            he.prototype.handleInteractionEnd.apply(this, arguments),
            this.origHit = null,
            this.hit = null,
            this.component.hitsNotNeeded()
        },
        handleScrollEnd: function () {
            he.prototype.handleScrollEnd.apply(this, arguments),
    ...
    qt.touchMouseIgnoreWait = 500;
    var ge = St.extend(ue, le, {
        isTouching: !1,
        mouseIgnoreDepth: 0,
    ...
    var pe = St.extend(ue, {
      ...
      , ve = qt.Grid = St.extend(ue, {
          ...
          getSafeHitSpan: function (t) {
              ...
              return $(e, this.view.activeRange) ? e : null
          },
          ...
          buildDayClickListener: function () {
              var t, e = this, n = this.view, i = new fe(this, {
                  ...
                  interactionEnd: function (i, r) {
                      var s;
                      !r && t && (s = e.getSafeHitSpan(t),
                      s && n.triggerDayClick(s, e.getHitEl(t), i))
                  }
              });
          ...
          getDayClasses: function (t, e) {
              var n, i = this.view, r = [];
              return q(t, i.activeRange) ? (r.push("fc-" + Xt[t.day()]),
              1 == i.currentRangeAs("months") && t.month() != i.currentRange.start.month() && r.push("fc-other-month"),
              n = i.calendar.getNow(),
              t.isSame(n, "day") ? (r.push("fc-today"),
              e !== !0 && r.push(i.highlightStateClass)) : t < n ? r.push("fc-past") : r.push("fc-future")) : r.push("fc-disabled-day"),
              r
          }
      });
    ve.mixin({
        ...
        buildBusinessHourEvents: function (e, n) {
            ...
            return null == n && (n = r.options.businessHours),
            i = r.computeBusinessHourEvents(e, n),
            !i.length && n && (i = [t.extend({}, Ie, {
        ...
        buildSegDragListener: function (t) {
            ...
            var c = this.segDragListener = new fe(a, {
                ...
                interactionStart: function (i) {
                    ...
                    n = new pe(t.el, {
                        ...
                        parentEl: a.el,
                        opacity: c.isTouch ? null : a.opt("dragOpacity"),
                ...
                dragStart: function (n) {
                    c.isTouch && !a.isEventSelected(u) && a.selectEvent(u),
                    e = !0,
                ...
                hitOver: function (e, o, l) {
                    var d, h, f, g = !0;
                    t.hit && (l = t.hit),
                    d = l.component.getSafeHitSpan(l),
                    h = e.component.getSafeHitSpan(e),
                    d && h ? (i = r.computeEventDrop(d, h, u),
                    g = i && r.isEventLocationAllowed(i, u)) : g = !1,
                    g || (i = null,
                    s()),
                    i && (f = a.renderDrag(i, t)) ? (f.addClass("fc-dragging"),
                    c.isTouch || r.applyDragOpacity(f),
                    n.hide()) : n.show(),
                    o && (i = null)
                },
                hitOut: function () {
        ...
        listenToExternalDrag: function (t, e, n) {
            var i, r = this, a = this.view, l = Mt(t), u = r.externalDragListener = new fe(this, {
                interactionStart: function () {
        ...
        buildSegResizeListener: function (t, e) {
            var n, i, r = this, a = this.view, l = a.calendar, u = t.el, c = t.event, d = l.getEventEnd(c), h = this.segResizeListener = new fe(this, {
                scroll: a.opt("dragScroll"),
                subjectEl: u,
                interactionStart: function () {
                    n = !1
                ...
                hitOver: function (n, o, l) {
                    ...
                    h && f ? (i = e ? r.computeEventStartResize(h, f, c) : r.computeEventEndResize(h, f, c),
                    u = i && r.isEventLocationAllowed(i, c)) : u = !1,
                    u ? i.start.isSame(c.start.clone().stripZone()) && i.end.isSame(d.clone().stripZone()) && (i = null) : (i = null,
                    s()),
                    i && (a.hideEvent(c),
                ...
                interactionEnd: function (e) {
                    ...
                    i ? a.reportSegResize(t, i, r.largeUnit, u, e) : a.showEvent(c),
        ...
        isEventLocationInRange: function (t) {
            return $(this.eventToRawRange(t), this.view.validRange)
        },
        ...
        sortEventSegs: function (t) {
            t.sort(vt(this, "compareEventSegs"))
        },
    ...
    var me = qt.DayTableMixin = {
        ...
        renderHeadDateCellHtml: function (t, e, n) {
            var i = this.view
              ...
              , o = ut(t.format(this.colHeadFormat));
            return 1 === this.rowCnt ? s = s.concat(this.getDayClasses(t, !0)) : s.push("fc-" + Xt[t.day()]),
      ...
      , ye = qt.DayGrid = ve.extend(me, {
          ...
          renderNumberCellHtml: function (t) {
              var e, n, i = this.view, r = "", s = q(t, i.activeRange), o = i.dayNumbersVisible && s;
    ...
    ye.mixin({
        ...
        unrenderEvents: function () {
            this.removeSegPopover(),
            ve.prototype.unrenderEvents.apply(this, arguments)
        },
        getEventSegs: function () {
            return ve.prototype.getEventSegs.call(this).concat(this.popoverSegs || [])
        },
        renderBgSegs: function (e) {
            var n = t.grep(e, function (t) {
                return t.event.allDay
            });
            return ve.prototype.renderBgSegs.call(this, n)
        },
        ...
        fgSegHtml: function (t, e) {
            var n, i, r = this.view, s = t.event, o = r.isEventDraggable(s), a = !e && s.allDay && t.isStart && r.isEventResizableFromStart(s), l = !e && s.allDay && t.isEnd && r.isEventResizableFromEnd(s), u = this.getSegClasses(t, o, a || l), c = dt(this.getSegSkinCss(t)), d = "";
            return u.unshift("fc-day-grid-event", "fc-h-event"),
            t.isStart && (n = this.getEventTimeText(s),
            n && (d = '<span class="fc-time">' + ut(n) + "</span>")),
            i = '<span class="fc-title">' + (ut(s.title || "") || "&nbsp;") + "</span>",
            '<a class="' + u.join(" ") + '"' + (s.url ? ' href="' + ut(s.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '><div class="fc-content">' + (this.isRTL ? i + " " + d : d + " " + i) + "</div>" + (a ? '<div class="fc-resizer fc-start-resizer" />' : "") + (l ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
    ...
    ye.mixin({
        ...
        limitRow: function (e, n) {
            function i(i) {
                for (; E < i;)
                    u = S.getCellSegs(e, E, n),
                    u.length && (h = s[n - 1][E],
                    y = S.renderMoreLink(e, E, u),
                    m = t("<div/>").append(y),
                    h.append(m),
                    b.push(m[0])),
                    E++
            }
            var r, s, o, a, l, u, c, d, h, f, g, p, v, m, y, S = this, w = this.rowStructs[e], b = [], E = 0;
        ...
        renderMoreLink: function (e, n, i) {
            var r = this
              , s = this.view;
            //var popoverheight = $('.scroll-6').height();
            return t('<a class="fc-more"/>').text(this.getMoreLinkText(i.length)).on("click", function (o) {
                ...
                if (angular.element(".fc-popover.fc-more-popover").length > 0) {
                    angular.element(".fc-popover.fc-more-popover")[0].style.top = '0px'
                    angular.element(".fc-popover.fc-more-popover").css("height", "385");
                    angular.element(".fc-popover.fc-more-popover").css("overflow-y", "scroll");
                    angular.element(".fc-popover.fc-more-popover").css("overflow-x", "hidden");
                    angular.element(".fc-event-container").css("height", "");
                  //  angular.element(".fc-scroller.fc-day-grid-container")
        ...
        showSegPopover: function (t, e, n, i) {
            ...
            this.segPopover = new ce(s),
            this.segPopover.show(),
            this.bindSegHandlersToEl(this.segPopover.el)
        },
        renderSegPopoverContent: function (e, n, i) {
            var r, s = this.view, o = s.opt("theme"), a = this.getCellDate(e, n).format(s.opt("dayPopoverFormat")), l = t('<div class="fc-header ' + s.widgetHeaderClass + '"><span class="fc-close ' + (o ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span><span class="fc-title">' + ut(a) + '</span><div class="fc-clear"/></div><div class="fc-body ' + s.widgetContentClass + '"><div class="fc-event-container"></div></div>'), u = l.find(".fc-event-container");
    ...
    var Se = qt.TimeGrid = ve.extend(me, {
        slotDuration: null,
        snapDuration: null,
        snapsPerSlot: null,
        labelFormat: null,
        ...
        renderSlatRowHtml: function () {
            for (var t, n, i, r = this.view, s = this.isRTL, o = "", a = e.duration(+this.view.minTime) ; a < this.view.maxTime;)
                ...
                n = pt(_(a, this.labelInterval)),
                i = '<td class="fc-axis fc-time ' + r.widgetContentClass + '" ' + r.axisStyleAttr() + ">" + (n ? "<span>" + ut(t.format(this.labelFormat)) + "</span>" : "") + "</td>",
        ...
        computeLabelInterval: function (t) {
            var n, i, r;
            for (n = Ae.length - 1; n >= 0; n--)
                if (i = e.duration(Ae[n]),
                r = _(i, t),
                pt(r) && r > 1)
                    return i;
            return e.duration(t)
    ...
    Se.mixin({
        ...
        fgSegHtml: function (t, e) {
            var n, i, r, s = this.view, o = t.event, a = s.isEventDraggable(o), l = !e && t.isStart && s.isEventResizableFromStart(o), u = !e && t.isEnd && s.isEventResizableFromEnd(o), c = this.getSegClasses(t, a, l || u), d = dt(this.getSegSkinCss(t));
            ...
            '<a class="' + c.join(" ") + '"' + (o.url ? ' href="' + ut(o.url) + '"' : "") + (d ? ' style="' + d + '"' : "") + '><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + ut(r) + '" data-full="' + ut(i) + '"><span>' + ut(n) + "</span></div>" : "") + (o.title ? '<div class="fc-title">' + ut(o.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
        ...
        sortForwardSegs: function (t) {
            t.sort(vt(this, "compareForwardSegs"))
        },
    ...
    var we = qt.View = St.extend(le, ue, {
        type: null,
        name: null,
        title: null,
        calendar: null,
        ...
        formatRange: function (t, e, n) {
            ...
            oe(t.start, i, e, n, this.opt("isRTL"))
        },
        getAllDayHtml: function () {
            return this.opt("allDayHtml") || ut(this.opt("allDayText"))
        },
        buildGotoAnchorHtml: function (e, n, i) {
            ...
            n = n ? " " + ht(n) : "",
            i = i || "",
            !o && this.opt("navLinks") ? "<a" + n + ' data-goto="' + ut(JSON.stringify(a)) + '">' + i + "</a>" : "<span" + n + ">" + i + "</span>"
        },
        setElement: function (t) {
            this.el = t,
            this.bindGlobalHandlers(),
        ...
        unsetDate: function () {
            this.isDateSet && (this.isDateSet = !1,
        ...
        executeDateRender: function (t) {
            var e = this
              , n = !1;
            return t && (n = e.setRangeFromDate(t)),
            t && !n && e.isDateRendered ? Et.resolve() : (t ? this.captureInitialScroll() : this.captureScroll(),
            this.freezeHeight(),
        ...
        startNowIndicator: function () {
            ...
            t && (n = vt(this, "updateNowIndicator"),
        ...
        captureScroll: function () {
            return !this.capturedScrollDepth++ && (this.capturedScroll = this.isDateRendered ? this.queryScroll() : {},
            !0)
        },
        captureInitialScroll: function (e) {
            this.captureScroll() && (this.capturedScroll.isInitial = !0,
            e ? t.extend(this.capturedScroll, e) : this.capturedScroll.isComputed = !0)
        },
        ...
        discardScroll: function () {
            return !--this.capturedScrollDepth && (this.capturedScroll = null,
            !0)
        },
        ...
        bindEvents: function () {
            var t = this;
            this.isEventsBound || (this.isEventsBound = !0,
        ...
        unbindEvents: function () {
            this.isEventsBound && (this.isEventsBound = !1,
        ...
        unsetEvents: function () {
            this.isEventsSet && (this.isEventsSet = !1,
            this.handleEventsUnset(),
            this.trigger("eventsUnset"))
        },
        whenEventsSet: function () {
            var t = this;
            return this.isEventsSet ? Et.resolve(this.getCurrentEvents()) : new Et(function (e) {
                t.one("eventsSet", e)
            }
            )
        },
        ...
        requestCurrentEventsRender: function () {
            return this.isEventsSet ? void this.requestEventsRender(this.getCurrentEvents()) : Et.reject()
        },
        ...
        executeEventsUnrender: function () {
            return this.isEventsRendered && (this.onBeforeEventsUnrender(),
            this.captureScroll(),
            this.freezeHeight(),
        ...
        isEventStartEditable: function (t) {
            return lt(t.startEditable, (t.source || {}).startEditable, this.opt("eventStartEditable"), this.isEventGenerallyEditable(t))
        },
        isEventGenerallyEditable: function (t) {
            return lt(t.editable, (t.source || {}).editable, this.opt("editable"))
        },
        ...
        isEventResizable: function (t) {
            var e = t.source || {};
            return lt(t.durationEditable, e.durationEditable, this.opt("eventDurationEditable"), t.editable, e.editable, this.opt("editable"))
        },
    ...
    we.mixin({
        ...
        intervalStart: null,
        intervalEnd: null,
        setRangeFromDate: function (t) {
            var e = this.buildRangeInfo(t);
            return (!this.activeRange || !Q(this.activeRange, e.activeRange)) && (this.currentRange = e.currentRange,
            this.currentRangeUnit = e.currentRangeUnit,
            this.renderRange = e.renderRange,
            this.activeRange = e.activeRange,
            this.validRange = e.validRange,
            this.dateIncrement = e.dateIncrement,
            this.currentDate = e.date,
            this.minTime = e.minTime,
            this.maxTime = e.maxTime,
            this.start = e.activeRange.start,
            this.end = e.activeRange.end,
        ...
        buildPrevRangeInfo: function (t) {
            var e = t.clone().startOf(this.currentRangeUnit).subtract(this.dateIncrement);
            return this.buildRangeInfo(e, -1)
        },
        buildNextRangeInfo: function (t) {
            var e = t.clone().startOf(this.currentRangeUnit).add(this.dateIncrement);
            return this.buildRangeInfo(e, 1)
        },
        buildRangeInfo: function (t, n) {
            var i, r, s, o, a = this.buildValidRange(), l = j(t, a), u = null, c = null;
            return i = this.buildCurrentRangeInfo(l, n),
            r = this.buildRenderRange(i.range, i.unit),
            s = W(r),
            this.opt("showNonCurrentDates") || (s = U(s, i.range)),
            u = e.duration(this.opt("minTime")),
            c = e.duration(this.opt("maxTime")),
            this.adjustActiveRange(s, u, c),
            s = U(s, a),
            l = j(l, s),
            o = q(t, i.range) && Z(i.range, a),
            {
                validRange: a,
        ...
        buildCurrentRangeInfo: function (t, e) {
            ...
            s = this.buildRangeFromDayCount(t, e, n)) : (s = this.buildCustomVisibleRange(t)) ? r = O(s.start, s.end) : (i = this.getFallbackDuration(),
            r = O(i),
        ...
        buildRangeFromDuration: function (t, e, n, i) {
            var r, s = this.opt("dateAlignment"), o = t.clone();
            return n.as("days") <= 1 && this.isHiddenDay(o) && (o = this.skipHiddenDays(o, e),
            o.startOf("day")),
            o.startOf(s || i),
            r = o.clone().add(n),
            {
    ...
    var Ee = qt.Calendar = St.extend({
        ...
        populateOptionsHash: function () {
            var t, e, i, r;
            t = lt(this.dynamicOverrides.locale, this.overrides.locale),
            e = De[t],
            e || (t = Ee.defaults.locale,
            e = De[t] || {}),
            i = lt(this.dynamicOverrides.isRTL, this.overrides.isRTL, e.isRTL, Ee.defaults.isRTL),
            r = i ? Ee.rtlDefaults : {},
            this.dirDefaults = r,
        ...
        buildViewSpec: function (t) {
            for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], c = [], d = [], h = t; h;)
                i = Zt[h],
                r = l[h],
                h = null,
                "function" == typeof i && (i = {
            ...
            s && (o = e.duration(s),
            o.valueOf() && (a = O(o),
            "week" === a && "object" == typeof s && s.days && (a = "day"),
            i.duration = o,
            i.durationUnit = a,
        ...
        prev: function () {
            var t = this.view.buildPrevRangeInfo(this.currentDate);
            t.isValid && (this.currentDate = t.date,
            this.renderView())
        },
        next: function () {
            var t = this.view.buildNextRangeInfo(this.currentDate);
            t.isValid && (this.currentDate = t.date,
            this.renderView())
        },
        prevYear: function () {
    ...
    qt.locale("en", Ee.englishDefaults),
    ...
    var Re = {
      ...
      , xe = 1;
    Ee.prototype.mutateSeg = function (t, e) {
    ...
    Ee.prototype.isEventSpanAllowed = function (t, e) {
        var n = e.source || {}
          , i = lt(e.constraint, n.constraint, this.options.eventConstraint)
          , r = lt(e.overlap, n.overlap, this.options.eventOverlap);
        ...
        a = 0; a < o.length; a++)
            ...
            this.eventIntersectsRange(l, t)) {
                ...
                if ("function" == typeof n && !n(l, i))
                    return !1;
                if (i) {
                    if (u = lt(l.overlap, (l.source || {}).overlap),
                    u === !1)
                        return !1;
    ...
    var ke = qt.BasicView = we.extend({
        ...
        instantiateDayGrid: function () {
            var t = this.dayGridClass.extend(Le);
            return new t(this)
        },
        buildRenderRange: function (t, e) {
            var n = we.prototype.buildRenderRange.apply(this, arguments);
      ...
      , Le = {
          renderHeadIntroHtml: function () {
              var t = this.view;
              return t.colWeekNumbersVisible ? '<th class="fc-week-number ' + t.widgetHeaderClass + '" ' + t.weekNumberStyleAttr() + "><span>" + ut(t.opt("weekNumberTitle")) + "</span></th>" : ""
          },
          renderNumberIntroHtml: function (t) {
              var e = this.view
      ...
      , Me = qt.MonthView = ke.extend({
          buildRenderRange: function () {
              var t, e = ke.prototype.buildRenderRange.apply(this, arguments);
    ...
    var Be = qt.AgendaView = we.extend({
        scroller: null,
        timeGridClass: Se,
        timeGrid: null,
        dayGridClass: ye,
        ...
        updateSize: function (t) {
            ...
            we.prototype.updateSize.call(this, t)
        },
        updateWidth: function () {
      ...
      , Fe = {
          renderHeadIntroHtml: function () {
              ...
              }, ut(t)) + "</th>") : '<th class="fc-axis ' + e.widgetHeaderClass + '" ' + e.axisStyleAttr() + "></th>"
          },
          renderBgIntroHtml: function () {
              var t = this.view;
    ...
    var Ge = we.extend({
      ...
      , Oe = ve.extend({
          ...
          handleSegClick: function (e, n) {
              var i;
              ve.prototype.handleSegClick.apply(this, arguments),
          ...
          renderEmptyMessage: function () {
              this.el.html('<div class="fc-list-empty-wrap2"><div class="fc-list-empty-wrap1"><div class="fc-list-empty">' + ut(this.view.opt("noEventsMessage")) + "</div></div></div>")
          },
          ...
          dayHeaderHtml: function (t) {
              ...
              }, ut(t.format(n))) : "") + (i ? e.buildGotoAnchorHtml(t, {
          ...
          fgSegHtml: function (t) {
              ...
              return e = s.allDay ? n.getAllDayHtml() : n.isMultiDayEvent(s) ? t.isStart || t.isEnd ? ut(this.getEventTimeText(t)) : n.getAllDayHtml() : ut(this.getEventTimeText(s)),
              o && i.push("fc-has-url"),
              '<tr class="' + i.join(" ") + '">' + (this.displayEventTime ? '<td class="fc-list-item-time ' + n.widgetContentClass + '">' + (e || "") + "</td>" : "") + '<td class="fc-list-item-marker ' + n.widgetContentClass + '"><span class="fc-event-dot"' + (r ? ' style="background-color:' + r + '"' : "") + '></span></td><td class="fc-list-item-title ' + n.widgetContentClass + '"><a' + (o ? ' href="' + ut(o) + '"' : "") + ">" + ut(t.event.title || "") + "</a></td></tr>"
          }
      });
    return Zt.list = {
        class: Ge,
